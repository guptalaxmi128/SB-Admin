...
import { Layout, Menu, message, Button, Breadcrumb, Tabs } from "antd";
...
import DeletedQualification from "./DeletedQualification";
          ...
          <Content>
            <div className="flex justify-between items-center pt-5 pl-5 pr-5">
              ...
              <Breadcrumb className="font-poppins">
                ...
                <Breadcrumb.Item>
                  <a href="/admin/instructor-verification">Instructor</a>
                </Breadcrumb.Item>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md m-5">
              <div>
                <Tabs defaultActiveKey="view">
                  ...
                  <TabPane
                    tab="Deleted Qualification"
                    key="deletedQualification"
                  >
                    <DeletedQualification id={id} />
                  </TabPane>
                </Tabs>
              </div>
            </div>
...
export default TabQualification;
