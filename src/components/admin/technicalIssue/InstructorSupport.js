...
const InstructorSupport = () => {
  ...
  useEffect(() => {
    const dummyData = [
      { id: 1, user: 'Ankush Gupta', issue: 'Lorem ipsum dolor sit amet.' },
      { id: 2, user: 'Navya Gupta', issue: 'Consectetur adipiscing elit.' },
      { id: 3, user: 'Ram Gupta', issue: 'Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.' },
    ];
