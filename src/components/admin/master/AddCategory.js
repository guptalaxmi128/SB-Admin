...
import {
  ...
  getCategory,
  deleteCategory,
} from "../../../actions/admin/category/category";
...
const AddCategory = () => {
  ...
  const courseCategory = useSelector((state) => state.category.category);
  ...
  useEffect(() => {
    if (courseCategory && courseCategory.data) {
      setData(courseCategory.data);
    }
  }, [courseCategory]);
  ...
  const handleDelete = (id) => {
    console.log(`Category ${id} is clicked for delete`);
    ...
    <div className="p-4">
      ...
      <div className="bg-white rounded-lg p-6 shadow-md mt-3">
        ...
        <div className="mt-5">
          {data.length > 0 ? (
            <>
              <h5 className="font-poppins text-lg mb-2 ">Category List</h5>
