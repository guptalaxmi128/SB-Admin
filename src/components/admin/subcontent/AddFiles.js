...
import { Button, Upload, message, Breadcrumb } from "antd";
import {  InboxOutlined } from "@ant-design/icons";

import { useDispatch } from "react-redux";
import { addAdminFile } from "../../../actions/admin/content/content";
      ...
      <div className="p-4">
        ...
        <div>
          <div className="flex align-center justify-between">
            ...
            <div className="bg-white rounded-lg p-6 shadow-md mt-3 w-full lg:w-4/12 ml-1">
              <h2 className="font-poppins font-semibold text-base">File Settings</h2>
              <div>
                {showNames.length > 0 && (
                  <div>
